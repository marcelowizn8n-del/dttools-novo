...
const translations = {
  ...
  "en": {
    ...
    "admin.plans.toast.update.success.title": "Plan updated",
    "admin.plans.toast.update.success.description": "The changes were saved successfully.",
    "admin.plans.toast.update.error.title": "Error updating plan",
    "admin.plans.toast.update.error.description": "An error occurred while trying to save the changes.",
  },
