...
const translations = {
  ...
  "de": {
    ...
    // Pricing Page (basic keys)
    "pricing.title": "W e4hlen Sie den perfekten Plan f fcr Sie",
    "pricing.subtitle": "Verwandeln Sie Ihre Ideen mit den fortschrittlichsten Design-Thinking-Tools in innovative L f6sungen. Starten Sie kostenlos und wachsen Sie mit Ihren Bed fcrfnissen.",
    "pricing.monthly": "Monatlich",
    "pricing.yearly": "J e4hrlich",
    "pricing.save": "Sparen Sie bis zu 10%",
    "pricing.popular": "Am beliebtesten",
    
    // Buttons
    "btn.start.free": "Kostenlos starten",
    "btn.start.trial": "Kostenlose Testversion starten",
    
    // Currency
    "currency.symbol": " f8",
    "currency.month": "/Monat",
    "currency.year": "/Jahr",
    "currency.save": "Sparen Sie {percent}% j e4hrlich",
  },
  
  "zh": {
    // Navigation
    "nav.projects": " e9 a1 8b e7 9b ae",
    "nav.library": " 8b 91 e6 96 87 e5 ba 93",
    "nav.pricing": " e4 bb b7 e6 a0 bc",
    "nav.admin": " e7 ae a1 e7 90 86",
    "nav.logout": " e9 80 80 e5 87 ba",
    "nav.login": " e7 99 bb e5 bd 95",
    
    // Pricing Page (basic keys)
    "pricing.title": " e9 80 89 e6 8b a9 e6 9c 80 e9 80 82 e5 90 88 e6 82 a8 e7 9a 84 e8 ae a1 e5 88 92",
    "pricing.subtitle": " e4 bd bf e7 94 a8 e6 9c 80 e5 b1 82 e8 b4 9a e7 9a 84 e8 ae be e8 ae a1 e6 80 9d e7 bb 8fog e5 b7 a5 e5 85 b7 ef bc 8c e5 b0 86 e6 82 a8 e7 9a 84 e6 80 9d e8 b7 af e8 bd ac e5 8c 96 e4 b8 ba e5 88 9b e6 96 b0 e8 a7 a3 e5 86 b3 e6 96 b9 e6 a1 88 e3 80 82 e5 85 8d e8 b4 b9 e5 bc 80 e5 a7 8b ef bc 8c e5 b9 b6 e4 b8 8e e9 9c 80 8d 90 9b e5 a2 b3 e8 80 8c e5 8f 98 e5 8c 96 e3 80 82",
    "pricing.monthly": " e6 9c 88 e4 bb 98",
    "pricing.yearly": " e5 b9 b4 e4 bb 98",
    "pricing.save": " e6 9c 80 e5 a4 a7 e5 8f af e8 ae a91 30%",
    "pricing.popular": " e6 9c 80 e5 8f 97 e6 ac a2",
